...
const ProfitTarget = observer(({profitTargetId, removeProfitTarget}: any) => {
  ...
  const handleOnChangeProfit = (event: any) => {
  ...
  const handleOnBlurProfit = (event: any) => {
    let totalValue = 0
  ...
  const handleOnChangeTargetPrice = (event: any) => {
    const value = checkOnNumbers(event.target.value)
    if (+value <= 0) {
  ...
  const handleOnChangeAmountToSell = (event: any) => {
    const value = checkOnNumbers(event.target.value)
    let totalValue = 0
    profitTargetState.map(el => {
  ...
  const handleOnBlurAmountToSell = (event: any) => {
    let totalValue = 0
    profitTargetState.map(el => {
      totalValue = totalValue + +el.amountToSell
    })
